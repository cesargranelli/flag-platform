...
/// Dados de um item do menu de módulos (label + branch + restrição).
...
/// Item do menu de módulos do header (Kickster pill pattern).
///
/// Altura de toque 48px. Estados:
/// - **Ativo**: fundo branco sólido, texto `primary` w600, raio 100 (pill).
/// - **Hover**: fundo branco @8%.
/// - **Foco**: outline branco 2px.
/// - **Inativo**: fundo transparente, texto branco @90% w500.
